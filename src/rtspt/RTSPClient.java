    ...
    public static void main(String[] args) {
        try {
        	Thread t = new Thread(new Runnable() {
				...
				public void run() {
		        	try {
		        		ServerSocket ss = new ServerSocket(16264);
						ss.accept();
            ...
            RTSPClient client = new RTSPClient(
                    new InetSocketAddress("183.58.12.213", 554),
                    new InetSocketAddress("192.168.0.149", 0),
//                    "rtsp://218.207.101.236:554/mobile/3/67A451E937422331/8jH5QPU5GWS07Ugn.sdp");
//                    "rtsp://183.58.12.213:554/PLTV/88888905/224/3221227122/10000100000000060000000000937770_0.smil?icpid=88888888&from=273");
            
                    "rtsp://192.168.0.149:8554/test");
                    client.start();
        } catch (Exception e) {
            e.printStackTrace();
        }
